...
def post_add():
    ...
    with cont.container():
        ...
        form.write("💡 If you leave the checkbox unselected, “Working rights required for this role” will be shown in the job ad.")
        ...
        data = {"hashJobId":hashJobId,"numApplicants":0,"JobTitle":JobTitle,"jobType":jobType,"datePosted":datePosted,"visaSponsered":(visaSponsered==True and "Work visa can be sponsered") or "No sponsorship","experience":experience,"jobDesp":jobDesp}
        # lst = []
